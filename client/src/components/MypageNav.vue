<template>
    <div>
        <b-navbar class="mypagenav justify-content-center mt-3" toggleable="lg" type="dark">
                <b-navbar-nav class="navout">
                    ...
                    >
                        <router-link class="navLink" :to="menu.path">{{ menu.title }}</router-link>
                    </b-nav-item>
                    <b-nav-item
                        v-if="getRole==1"
                    ...
                    >
                        <router-link class="navLink" to="/mypage/manage">회원 관리</router-link>
                    </b-nav-item>
                </b-navbar-nav>
            </b-navbar>
        <hr/>     
