...
public class NaverController {
    ...
    private static class NaverTask {
        static String go(String keyword) {
            
            String clientId = "FPqsQxfGHoj_c8wfPptR"; // 애플리케이션 클라이언트 아이디값"
            String clientSecret = "QthbALG5dx"; // 애플리케이션 클라이언트 시크릿값"
            ...
            int count = 15; // 15개의 뉴스 정보
            String apiURL = "https://openapi.naver.com/v1/search/news?query=" + text + "&display="+ count; // json 결과
