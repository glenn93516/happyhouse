    ...
    <div class="container-fluid bg-secondary w-100 d-flex align-items-center" style="height: 80vh;">
    	...
    	<c:if test="${not empty user}">
    		<div class="container bg-light rounded" style="width: 700px;">
	            <h1 class="m-md-3">비밀번호 수정</h1>
	            <form action="${root}/find.do" method="post" class="m-md-3 py-md-3">
	            	<input type="hidden" name="act" value="modifyPw">
	            	<input type="hidden" name="userId" value="${user.userid}">
	                <div class="form-group row">
	                    <label for="newPw" class="col-md-2 col-form-label text-right">새 비밀번호</label>
	                    <div class="col-md-10">
	                    	<input type="password" id="newPw" name="newPw" class="form-control" placeholder="비밀번호 입력" required>
	                    </div>
	                </div>
	                <div class="form-group row">
